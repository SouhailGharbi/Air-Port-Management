...
Passenger ps = new Passenger
{
    ...
    EmailAddress = "souhail.gharbi@esprit.tn"
};

Console.WriteLine(ps.CheckProfile("souhail", "gharbi", "souhail.gharbi@esprit.tn"));
...
//TP6
//IUnitOfWork unitOfWork = new UnitOfWork(new AMContext());

//IServiceFlight serviceflight = new ServiceFlight(unitOfWork);

//foreach (Flight f in serviceflight.GetFlights(5))
//{
//    Console.WriteLine(f);
...
//IServicePlane servicepalen = new ServicePlane(unitOfWork);

//servicepalen.deletplane();
